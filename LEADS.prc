create or replace procedure U_RPT_AVLBL_LEADS_SC1
  (
   ...
   in_trace          in number   default 0,                                         --ïðèçíàê òðàññèðîâêè 0/1
   in_stop_procedure in number   default 0                                          --íå ñìîòðåòü ïðèçíàê îñòàíîâêè ïðîöåäóðû
  ) authid current_user as

  lc_process varchar2(100) := 'U_RPT_AVLBL_LEADS_SC1';        --Íàèìåíîâàíèå ïðîöåññà äëÿ ëîãà
  lc_sql     varchar2(20000);                                      --Òåêñò SQL çàïðîñ
  ln_step    number := 0;                                          --Íîìåð øàãà
  ln_lastId  number;                                               --Ññûëêà â ëîã íà òåêóùèé ïðîöåññ
  lc_error   varchar2(1000);                                       --Òåêñò îøèáêè
  --Âðåìåííûå òàáëèöû
...
begin
  ...
  --ïðîâåðêà íà îòñóòñòâèå ôëàæêà, ÷òî íå íóæíî çàïóñêàòü ïðîöåäóðó
  ...
  --Çàïèñü â ëîã, ÷òî ïðîöåññ çàïóùåí
  ln_step := ln_step + 1;
